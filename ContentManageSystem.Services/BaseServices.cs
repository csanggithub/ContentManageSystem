...
using ContentManageSystem.Repository;
using System;
...
namespace ContentManageSystem.Services
{
    /// <summary>
    /// 管理类的基类
    /// </summary>
    ...
    public abstract class BaseServices<T> where T : class
    {
        ...
        /// 默认构造函数
        /// </summary>
        public BaseServices() : this(ContextFactory.CurrentContext())
        {
        }
        /// <summary>
        /// 构造函数
        ...
        {
            Repository = new BaseRepository<T>(dbContext);
        }
        ...
        /// </summary>
        /// <returns>总记录数</returns>
        public virtual int Count(Expression<Func<T, bool>> entity)
        {
